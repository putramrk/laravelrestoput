                ...
                <ul class="list-unstyled list-unstyled-border">
                    <li class="media">
                        ...
                        <div class="media-body">
                            ...
                            <div class="text-small text-muted">haqi <div class="bullet"></div> <span class="text-primary">Now</span></div>
                        </div>
                    </li>
                    <li class="media">
                        <div class="custom-control custom-checkbox">
                        ...
                        <div class="media-body">
                            ...
                            <div class="text-small text-muted">zharfan <div class="bullet"></div> 4 Min</div>
                        </div>
                    </li>
                    <li class="media">
                        <div class="custom-control custom-checkbox">
                        ...
                        <div class="media-body">
                            ...
                            <div class="text-small text-muted">deri syams <div class="bullet"></div> 8 Min</div>
                        </div>
                    </li>
                    <li class="media">
                        <div class="custom-control custom-checkbox">
                        ...
                        <div class="media-body">
                            ...
                            <div class="text-small text-muted">angga tria <div class="bullet"></div> 21 Min</div>
                        </div>
                    </li>
                </ul>
            </div>
